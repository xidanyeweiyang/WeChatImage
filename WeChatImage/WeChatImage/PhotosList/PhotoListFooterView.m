...
@implementation PhotoListFooterView
...
- (IBAction)previewAction:(id)sender {
    [self.delegate photoListFooterViewTapWithType:PhotoListFooterViewTapTypePreview];
}

- (IBAction)senderAction:(id)sender {
    [self.delegate photoListFooterViewTapWithType:PhotoListFooterViewTapTypeSend];
}
